...
def infer_vllm_supported_from_model_architecture(
    ...
    # These are typically used with custom load formats like runai_streamer
    # that bypass the standard HuggingFace model loading
    ...
    # For local paths and HuggingFace model IDs, validate architecture support
    try:
